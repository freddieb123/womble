                ...
                <div className="flex flex-col items-center justify-center h-[60vh] text-center">
                  <div className="w-48 h-48 mb-6 relative">
                    <svg viewBox="0 0 24 24" fill="none" className="w-full h-full text-blue-100">
                      <path d="M12 2C12.9193 2 13.8235 2.19379 14.6435 2.56418C15.4635 2.93457 16.1818 3.47589 16.7483 4.14215C17.3148 4.8084 17.7149 5.58322 17.9184 6.41661C18.122 7.24999 18.1236 8.11759 17.9231 8.95158C17.7226 9.78558 17.3252 10.5614 16.7611 11.2291C16.1969 11.8968 15.4805 12.44 14.6618 12.8125C13.843 13.185 12.9396 13.3811 12.0203 13.3834C11.101 13.3857 10.1966 13.1941 9.37575 12.8257V19C9.37575 19.5304 9.16504 20.0391 8.79059 20.4142C8.41614 20.7893 7.90837 21 7.37894 21H4.37575C3.84633 21 3.33856 20.7893 2.96411 20.4142C2.58966 20.0391 2.37894 19.5304 2.37894 19V14C2.37894 13.4696 2.58966 12.9609 2.96411 12.5858C3.33856 12.2107 3.84633 12 4.37575 12H7.37575V8.95C7.37575 7.34392 8.01646 5.80356 9.15807 4.66194C10.2997 3.52032 11.8401 2.87961 13.4461 2.87961" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
