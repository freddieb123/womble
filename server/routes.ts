...
const chatConfigSchema = z.object({
  ...
  type: z.enum(['chat', 'upload', 'quiz', 'two-way-conversation', 'teach-ai', 'thought-partner', 'quick-fire-quiz', 'group-board', 'user-tester']).default('chat'),
...
export function registerRoutes(app: Express): Server {
  ...
  app.post("/api/chat-configs", requireAuth, async (req: Request, res: Response) => {
    try {
      ...
      const autoGeneratedTypes = ['teach-ai', 'thought-partner', 'quick-fire-quiz', 'group-board', 'user-tester'];
